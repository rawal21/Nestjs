...
var PostSeeder = function () {
    ...
    var _classThis;
    var PostSeeder = _classThis = /** @class */ (function () {
        function PostSeeder_1(postModel) {
            this.postModel = postModel;
        }
        PostSeeder_1.prototype.onModuleInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                var count, tags, titles, generateSlug, randomPosts, i, title;
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            for (i = 0; i < 12; i++) {
                                ...
                                randomPosts.push({
                                    title: title,
                                    content: 'This is a randomly generated blog post for testing purposes. It contains simple placeholder text.',
                                    slug: generateSlug(title) + '-' + i,
                                    author: new mongoose_1.Types.ObjectId('690cd1a8a7a6f608483a3bdd'),
                                    tags: [tags[Math.floor(Math.random() * tags.length)]],
                                    category: '',
                                    imageUrl: ''
                                });
                            }
                            return [4 /*yield*/, this.postModel.deleteMany()];
                        case 2:
                            _a.sent();
    ...
    __setFunctionName(_classThis, "PostSeeder");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PostSeeder = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PostSeeder = _classThis;
}();
